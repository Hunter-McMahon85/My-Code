...
int 
*allocate_and_initialize_directly(int size) 
{
       	int *array = NULL;
...
void 
allocate_and_initialize_indirectly(int **array, int size) 
{
	//// Your code goes below this line.
...
void
allocate_and_initialize_chained(int *******array, int size)
{
	//// Your code goes below this line.
    	*array = (int ******) malloc(1 * sizeof *array);
    	**array = (int *****) malloc(1 * sizeof *array);
...
void
free_doubly_indirectly(int **array)
{
...
void
print_directly(int *array, int size)
{
    //// Your code goes below this line.
...
void
print_indirectly(int *array, int size) {
    //// Your code goes below this line.
    for (int i = 0; i < size; ++i)
        printf("%d", (array[i]));
    printf("\n");
...
void 
populate_directly(int *array, int size) {
    	//// Your code goes below this line.
	int i;
	for(i=0; i<size; i++)
	{
...
void 
populate_indirectly(int *array, int size) {
    //// Your code goes below this line.
...
void
populate_doubly_indirectly(int **array, int size)
{
    // Similar to print.
    for (int i = 0; i < size; ++i)
       (*array)[i] = i;
...
void
populate_chained(int ******array, int size)
{
    //// Your code goes below this line.
	int i;
	for(i=0; i<size; i++)
