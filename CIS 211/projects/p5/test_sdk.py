...
Project 5
Cis 211
code done based on instructions from https://github.com/CIS-UO/Duck_Sudoku/blob/master/doc/HOWTO-START.md
unittest for sdk_board.py
"""
import unittest
...
"""the following is given by the instructions"""
...
class TestGuessCheck(unittest.TestCase):
    ...
    def test_is_complete(self):
        board = Board()
        tiles_list = [
            "687539124", "243718965", "951264387", "419873652", "725691438", "836425791", "394182576", "168957243",
            "572346819"]
        board.set_tiles(tiles_list)
    ...
    def test_is_not_complete(self):
        board = Board()
        tiles_list = [
            "687539124", "243718965", "951264387", "419873652", "725691.38", "836425791", "394182576", "168957243",
            "572346819"]
        board.set_tiles(tiles_list)
