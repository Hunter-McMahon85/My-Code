	...
	while (i == 1){
		...
		*/
		int iter2= 0;
        	...
        	if (check_match == 1){
            		/* 
	    		makes it such that the code only checks sutiable canidates in words that are the same length
	    		*/
...
int main(int argc, char *argv[]){
	...
	/* reads the file and store its contents to memory with malloc*/
	...
	fclose(raw_file);
	/* reserve memory for the counters */
